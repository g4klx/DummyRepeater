...
BEGIN_EVENT_TABLE(CDummyRepeaterDongleSet, wxPanel)
...
CDummyRepeaterDongleSet::~CDummyRepeaterDongleSet()
{
}

bool CDummyRepeaterDongleSet::Validate()
{
...
DONGLE_TYPE CDummyRepeaterDongleSet::getType() const
{
	int n = m_type->GetSelection();
...
wxString CDummyRepeaterDongleSet::getDevice() const
{
...
unsigned int CDummyRepeaterDongleSet::getPort() const
{
	unsigned long n;
...
void CDummyRepeaterDongleSet::onType(wxCommandEvent& event)
{
