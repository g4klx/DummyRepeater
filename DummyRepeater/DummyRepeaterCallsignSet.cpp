...
CDummyRepeaterCallsignSet::CDummyRepeaterCallsignSet(wxWindow* parent, int id, const wxString& title, const wxString& callsign1, const wxString& callsign2) :
wxPanel(parent, id),
m_title(title),
m_callsign1(NULL),
m_callsign2(NULL)
...
CDummyRepeaterCallsignSet::~CDummyRepeaterCallsignSet()
{
}

bool CDummyRepeaterCallsignSet::Validate()
{
...
wxString CDummyRepeaterCallsignSet::getCallsign1() const
{
	return m_callsign1->GetValue().MakeUpper();
}

wxString CDummyRepeaterCallsignSet::getCallsign2() const
{
