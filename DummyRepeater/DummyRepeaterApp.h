/*
 *   Copyright (C) 2010,2011,2012,2014,2015,2018 by Jonathan Naylor G4KLX
 *
...
public:
	...
	virtual void getBleep(unsigned int& bleep) const;
	virtual void setBleep(unsigned int bleep) const;
...
wxDECLARE_APP(CDummyRepeaterApp);
